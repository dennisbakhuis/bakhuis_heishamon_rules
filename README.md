...
> 📖 **New here?** Start with the **[Installation Guide](INSTALLATION.md)** — it walks through HeishaMon setup, HA integration, the Climate Manager dashboard, and rules deployment in the correct order.
