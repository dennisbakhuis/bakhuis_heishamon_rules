"""Heating Manager for HeishaMon — Panasonic Aquarea weather-adaptive control.

This integration provides a Heating Manager for controlling a Panasonic Aquarea
...
"Heating Manager for HeishaMon" to configure.
"""
...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    async def _publish_room_temps(_event_or_time: object = None) -> None:
        ...
        setpoint_state = hass.states.get("number.heating_manager_room_setpoint_target")
    ...
    def _on_compressor_freq_change(event: object) -> None:
        ...
        state = hass.states.get("sensor.heating_manager_compressor_freq")
        ...
        if not was_above and is_above:
            ...
            hass.async_create_task(
                hass.services.async_call(
                    ...
                    "set_value",
                    {
                        "entity_id": "number.heating_manager_compressor_start_epoch",
                        "value": epoch,
                    },
                )
            )
