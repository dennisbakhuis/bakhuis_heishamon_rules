...
class TestScenarioA_ColdDay:
    ...
    def test_dynamic_shift_is_negative(self) -> None:
...
class TestScenarioC_Defrost:
    ...
    def test_shift_unchanged_during_defrost(self) -> None:
        shift = self.sim.get_global("dynamicShift")
        assert shift == -2, f"dynamicShift should remain -2 during defrost, got {shift}"

    def test_no_setpoint_written_during_defrost(self) -> None:
...
class TestScenarioD_CompressorOff:
    ...
    def test_pump_duty_low(self) -> None:
    ...
    def test_last_pump_duty_updated(self) -> None:
...
class TestScenarioE_CompressorOn:
    ...
    def test_pump_duty_high(self) -> None:
        duty = self.sim.get_sensor("SetMaxPumpDuty")
...
class TestScenarioF_BootInit:
    ...
    def test_last_setpoint_zero(self) -> None:
        assert self.sim.get_global("lastSetpoint") == 0

    def test_calculated_setpoint_fallback(self) -> None:
    ...
    def test_enable_min_freq(self) -> None:
        assert self.sim.get_global("enableMinFreq") == 1

    def test_dynamic_shift_zero(self) -> None:
        assert self.sim.get_global("dynamicShift") == 0

    def test_min_freq_margin(self) -> None:
        assert self.sim.get_global("minFreqMargin") == 3

    def test_enable_pump_control(self) -> None:
...
class TestScenarioG_WeatherCurveAccuracy:
    ...
    def test_curve_value(self, outdoor: float, expected: int, desc: str) -> None:
...
class TestScenarioI_RTCDisabled:
    ...
    def test_rtc_shift_stays_zero_after_multiple_calls(self) -> None:
...
class TestScenarioK_SoftStartRamp:
    ...
    def test_soft_start_shift(self, comp_run_sec: int, expected_shift: int, desc: str) -> None:
...
class TestScenarioL_SoftStartDisabled:
    ...
    def test_shift_zero_when_disabled(self) -> None:
        self.sim.call_function("calculateSoftStart")
        shift = self.sim.get_global("softStartShift")
...
class TestScenarioM_SoftStartWarmOutdoor:
    ...
    def test_shift_zero_when_warm_outdoor(self) -> None:
        self.sim.call_function("calculateSoftStart")
        shift = self.sim.get_global("softStartShift")
        assert shift == 0, (
    ...
    def test_shift_zero_at_exact_boundary(self) -> None:
...
class TestScenarioN_MinDynamicSoftStartShift:
    ...
    def test_soft_start_wins(self) -> None:
    ...
    def test_min_freq_wins(self) -> None:
